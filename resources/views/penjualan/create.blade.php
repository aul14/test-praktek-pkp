                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" readonly
                                ...
                                name="no_faktur" value="{{ old('no_faktur', 'NEW') }}">
                            @error('no_faktur')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off"
                                ...
                                id="tgl_faktur" name="tgl_faktur" value="{{ old('tgl_faktur') }}">
                            @error('tgl_faktur')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="ms_barang_id" id="ms_barang_id" required
                                ...
                                <option value=""></option>
                                @foreach ($brg as $val)
                                    <option value="{{ $val->id }}" data-harga="{{ $val->harga_jual }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('jumlah') is-invalid @enderror"
                                autocomplete="off" required id="jumlah" name="jumlah" value="{{ old('jumlah') }}">
                            @error('jumlah')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
